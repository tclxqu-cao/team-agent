...
```bash
npm install ./agentroam-cloudflared-darwin-arm64-0.2.0-preview.14.tgz \
  ./agentroam-runtime-darwin-arm64-0.2.0-preview.14.tgz \
  ./agentroam-tui-darwin-arm64-0.2.0-preview.14.tgz \
  ./agentroam-0.2.0-preview.14.tgz
npx agentroam
```
...
```powershell
npm install ./agentroam-cloudflared-win32-x64-0.2.0-preview.14.tgz `
  ./agentroam-runtime-win32-x64-0.2.0-preview.14.tgz `
  ./caoqu-agentroam-tui-win32-x64-0.2.0-preview.14.tgz `
  ./agentroam-0.2.0-preview.14.tgz
npx agentroam
```
