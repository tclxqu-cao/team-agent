...
export interface UserPreferences { userId: string; revision: number; theme: string; terminalFontSize: number; fileButtonPosition: ControlPosition; keybarPosition: ControlPosition; keybarHidden: boolean; keyOrder: string[]; updatedAt: string }
...
export interface CommandHistoryRecord { id: number; userId: string; terminalId: string; command: string; cwd: string; executedAt: string }
