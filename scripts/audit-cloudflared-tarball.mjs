...
if (packageJson.version !== "0.2.0-preview.3") throw new Error(`unexpected package version: ${packageJson.version}`);
...
if (manifest.packageVersion !== "0.2.0-preview.3") throw new Error(`unexpected manifest package version: ${manifest.packageVersion}`);
