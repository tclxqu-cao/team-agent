...
- [x] **Step 1: Add the checked-in manifest**
...
- [x] **Step 2: Implement pure discovery and SemVer rules**
...
- [x] **Step 3: Implement drift validation**
...
- [x] **Step 4: Implement mechanical version application**
...
- [x] **Step 5: Implement release-version reservation**
...
- [x] **Step 1: Define explicit allowlists and denylists**
...
- [x] **Step 2: Validate package dependency changes semantically**
...
- [x] **Step 3: Require tests for behavioral source changes**
...
- [x] **Step 1: Build a shared smoke harness**
...
- [x] **Step 2: Exercise the common session lifecycle**
...
- [x] **Step 3: Exercise supported control capabilities**
...
- [x] **Step 5: Add fake-adapter tests**
...
- [x] **Step 1: Model the seven-package release set**
...
- [x] **Step 2: Implement registry reads and idempotent publish planning**
...
- [x] **Step 3: Implement exact artifact verification**
...
- [x] **Step 4: Implement promotion and rollback**
...
- [x] **Step 5: Implement Gitee synchronization**
...
- [x] **Step 6: Add release state tests**
...
- [x] **Step 1: Add daily/manual discovery**
...
- [x] **Step 2: Create one deterministic candidate**
...
- [x] **Step 3: Add candidate checks without publish credentials**
...
- [x] **Step 4: Add provider-separated real smoke jobs**
...
- [x] **Step 5: Document repository configuration**
...
- [x] **Step 1: Gate trusted repair eligibility**
...
- [x] **Step 2: Run the official Codex action in isolation**
...
- [x] **Step 3: Validate and push through a separate step**
...
- [x] **Step 4: Enforce the repair limit**
...
- [x] **Step 1: Revalidate and auto-merge from trusted workflow code**
...
- [x] **Step 2: Rebuild without secrets**
...
- [x] **Step 3: Publish from artifact-only jobs**
...
- [x] **Step 4: Run hourly soak checks**
...
- [x] **Step 3: Update the package release runbook**
...
- [x] **Step 4: Validate workflow syntax and dry-run behavior**
